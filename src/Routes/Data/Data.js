  ...
  return (
    <div className='cover'>
      ...
      <div className="mt-4 content p-4  bg-white">
        <h1 className='font-bold text-xl text-fuchsia-500'>Data bundles</h1>
        <span className='text-sm text-gray-800n'>Enjoy Massive Data bonus using the KinaTech Pay service</span>
