                ...
                <div className="inputs mt-4">
                  ...
                  <div className='mt-4 mx-9 rounded-lg'>
                    ...
                    <div className="flex ">
                      ...
                      <input type="text" ref={_idGloRef} className="number text-sm text-center h-12 block" name='_Id' value={'glo'} />
                    </div>
                  </div>
                  ...
                  <div className='mt-4 mx-9 rounded-lg'>
                    ...
                    <div className="flex ">
                      ...
                      <input type="text" ref={GloAmountRef} className="number text-sm text-center h-12 block" name='amount' value={amount} />
                    </div>
                  </div>
